...
I$/D$ 位于前后端与 `NpcMemoryFabric` 之间，只缓存主存范围；MMIO 保持单拍 AXI-Lite 旁路。line refill
和 dirty writeback 逐个 XLEN beat 完成，不改变 AXI4/HBM 物理接口。基础 ISA 的任意 `FENCE`
