...
import _root_.npc.{CdeConfigResolver, FpgaConstruction}
import _root_.npc.fpga.{FpgaBoard, FpgaConfigParameters, FpgaElaborationManifest}
import _root_.npc.ComputeBackend
