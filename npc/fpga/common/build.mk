...
FPGA_MANIFEST_VALUES = \
		...
		XLEN=$(NPC_XLEN) M=$(NPC_M) F=$(NPC_F) D=$(NPC_D) ZICSR=$(ZICSR) \
...
FPGA_ELAB_MANIFEST_VALUES = \
	...
	NPC_TARGET=$(NPC_TARGET) NPC_XLEN=$(NPC_XLEN) NPC_PIPELINE=$(NPC_PIPELINE) NPC_ZICSR=$(ZICSR) NPC_ZIFENCEI=$(ZIFENCEI) \
