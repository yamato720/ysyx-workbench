...
FPGA_BUILD_REQUESTED := $(if $(filter fpga-check fpga-config fpga-plan fpga-elaborate fpga-ip fpga-synth fpga-link spmv-check spmv-elaborate spmv-ooc-synth spmv-link spmv-input-fpga-check spmv-input-fpga-elaborate spmv-input-fpga-ip spmv-input-fpga-package spmv-input-fpga-link spmv-cuperflow-fpga-check spmv-cuperflow-fpga-elaborate spmv-cuperflow-fpga-ip spmv-cuperflow-fpga-package spmv-cuperflow-fpga-link,$(MAKECMDGOALS)),1,)
