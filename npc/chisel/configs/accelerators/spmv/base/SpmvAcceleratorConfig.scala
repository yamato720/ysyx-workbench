...
final case class SpmvAcceleratorConfig(
  ...
  require(axiDataWidth >= 64 && SpmvPowerOfTwo(axiDataWidth) && axiDataWidth % 8 == 0,
  ...
  require(SpmvPowerOfTwo(elementsPerPc),
    s"SPMV elements per PC must be a positive power of two, got $elementsPerPc")
  require(SpmvPowerOfTwo(uramBanksPerPc),
  ...
  require(burstBeats > 0 && burstBeats <= 256 && SpmvPowerOfTwo(burstBeats),
