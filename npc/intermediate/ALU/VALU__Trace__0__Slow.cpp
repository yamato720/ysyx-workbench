...
VL_ATTR_COLD void VALU___024root__trace_init_sub__TOP__0(VALU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+4,0,"alu_control",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBus(c+5,0,"alu_result",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    ...
    tracep->declBit(c+7,0,"cout",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+8,0,"overflow",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+9,0,"result_temp",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 4,0);
    tracep->popPrefix();
}
...
VL_ATTR_COLD void VALU___024root__trace_full_0_sub_0(VALU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+2,(vlSelfRef.a),4);
    bufp->fullCData(oldp+3,(vlSelfRef.b),4);
    bufp->fullCData(oldp+4,(vlSelfRef.alu_control),3);
    bufp->fullCData(oldp+5,(vlSelfRef.alu_result),4);
    bufp->fullBit(oldp+6,(vlSelfRef.zero));
    bufp->fullBit(oldp+7,(vlSelfRef.cout));
    bufp->fullBit(oldp+8,(vlSelfRef.overflow));
    bufp->fullCData(oldp+9,(vlSelfRef.ALU__DOT__result_temp),5);
}
