/*
 * Local NEMU config for the zcu102-runtime source-built PS SDB.
 * Mirrors the current riscv64 native NEMU setup without relying on
 * nemu/include/generated/autoconf.h at build time.
 */
