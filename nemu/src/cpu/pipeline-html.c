...
static int write_document(
  ...
  static const char *prefix =
      ...
      "--if:#16697a;--id:#8f5d18;--ex:#8c2f39;--mem:#386641;--wb:#5a3d8a;--wait:#7a8794;--queue:#b25d19;--order:#486581}*{box-sizing:border-box}"
      ...
      ".stage.wait,.stage.queue,.stage.order,.stage[aria-label^=\"QUEUE\"],.stage[aria-label^=\"ORDER\"]{border:1px dashed rgba(255,255,255,.7);padding:3px 4px}.stage.wait{background:var(--wait)}.stage.queue,.stage[aria-label^=\"QUEUE\"]{background:var(--queue)}.stage.order,.stage[aria-label^=\"ORDER\"]{background:var(--order)}"
      ...
      "<div class=\"legend\"><span class=\"key\" style=\"--c:var(--if)\">IF</span><span class=\"key\" style=\"--c:var(--id)\">ID</span><span class=\"key\" style=\"--c:var(--ex)\">EX</span><span class=\"key\" style=\"--c:var(--mem)\">MEM</span><span class=\"key\" style=\"--c:var(--wb)\">WB</span><span class=\"key\" style=\"--c:var(--wait)\">WAIT</span><span class=\"key\" style=\"--c:var(--queue)\">QUEUE</span><span class=\"key\" style=\"--c:var(--order)\">ORDER</span></div>"
